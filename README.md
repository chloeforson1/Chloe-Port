...
#### [Reverse FIzzBUzz](https://github.com/LoyolaUnivMD/sp26-cs105-python-week-3-chloeforson1.git)ZZ
...
#### [Bi-Weekly Time Sheet](https://github.com/LoyolaUnivMD/sp26-cs105-python-week-2-chloeforson1.git)

![Screenshot 2026-04-21 at 9.32.08 PM.png](pics/Screenshot%202026-04-21%20at%209.32.08%E2%80%AFPM.png)
 - I created a biweekly time sheet in Microsoft Excel to track my hours and stay organized. IT was shown by columns for dates, shifts, and total hours, and used color coding to separate different weeks and highlight important information. I also used basic formulas to automatically calculate totals, which made the sheet more efficient and easier to update
 - This helped me plan time time out as a working student in knowing exactly when I need to clock in and out 
Some problem I have with it was making sure i could match the color to the corresponding date and time , as well as making sure the break duration match the total hours worked catagory
***
#### [Quiz and assessment Average](https://github.com/LoyolaUnivMD/sp26-cs105-python-week-3-chloeforson1.git)
